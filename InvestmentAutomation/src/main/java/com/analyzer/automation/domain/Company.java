...
public class Company {
	...
	public Company(String code,String sector,String companyName,String yearEnd,Double incomePerShare,Double equitiesPerShare,
	...
	public void setCode(String ticker) {
		this.code = ticker;
	}
